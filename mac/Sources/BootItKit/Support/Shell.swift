...
// `bytesHuman` moved to BootItShared/Formatting.swift — the daemon-side copy
// reporter needs it too, and a second implementation is exactly how the first
// one came to divide by 1024 while labelling the result GB.
